...
<style>
    ...
    .rank-card { background-color: #faf6ed; border: 1px solid #d4c8b0; border-radius: 10px; padding: 14px 18px; margin-bottom: 10px; display: flex; align-items: center; gap: 16px; }
    ...
    .unsaved { background-color: #f0d8b0; border-left: 4px solid #c47e3a; padding: 10px 14px; border-radius: 4px; font-weight: 600; margin: 12px 0; }
    .saved { background-color: #dde8c8; border-left: 4px solid #6a8a3a; padding: 10px 14px; border-radius: 4px; margin: 12px 0; }
</style>
""", unsafe_allow_html=True)

TAREFAS = ["30min+ exercício", "2L+ água", "Sem açúcar", "5h+ sono", "<6h tela", "1+ fruta"]
